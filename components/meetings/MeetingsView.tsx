...
import {
  ...
  CheckCircle, ChevronDown, ChevronUp, Trash2, Edit3, MessageCircle,
} from "lucide-react";
...
export default function MeetingsView() {
  ...
  const [form, setForm] = useState({ title: "", dateTime: "", attendees: "", type: "call", prepNotes: "" });
  ...
  const handleAdd = async () => {
    ...
    setForm({ title: "", dateTime: "", attendees: "", type: "call", prepNotes: "" });
    setShowAdd(false);
    await load();
    setAdding(false);
  };
